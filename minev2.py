...
class AttendanceMonitorApp(QMainWindow):
    def __init__(self):
        ...
        self.icon_path = os.path.abspath("logo.png")  # Store the icon path
    ...
    def load_settings(self):
        self.connection_fields['host'].setText(self.settings.value("host", "192.168.1.118"))
        self.connection_fields['port'].setText(self.settings.value("port", "1433"))
        self.connection_fields['database'].setText(self.settings.value("database", "BiometricDBtest"))
        self.connection_fields['username'].setText(self.settings.value("username", "sa"))
        self.connection_fields['password'].setText(self.settings.value("password", "a1!"))
    ...
    def connect_to_database(self):
        ...
        if success:
            ...
            notification = Notification(
                ...
                msg=f"Failed to connect to database: {message}",
                icon=self.icon_path,
                duration="short"
            )
            notification.set_audio(audio.Mail, loop=False)
    ...
    def start_monitoring(self):
        ...
        self.monitor_thread = FolderMonitorThread(self.folder_path_label.text(), self.db_manager, self.icon_path)
        ...
        notification = Notification(
            ...
            msg=f"Started monitoring folder: {self.folder_path_label.text()}",
            icon=self.icon_path,
            duration="short"
        )
        notification.set_audio(audio.Mail, loop=False)
    ...
    def stop_monitoring(self):
        ...
        notification = Notification(
            ...
            msg="Folder monitoring has been stopped",
            icon=self.icon_path,
            duration="short"
        )
        notification.set_audio(audio.Mail, loop=False)
